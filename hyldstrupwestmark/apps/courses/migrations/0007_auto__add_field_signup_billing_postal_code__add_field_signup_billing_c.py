...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signup.billing_postal_code'
        db.add_column('courses_signup', 'billing_postal_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Signup.billing_country'
        db.add_column('courses_signup', 'billing_country',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Signup.billing_postal_code'
        db.delete_column('courses_signup', 'billing_postal_code')

        # Deleting field 'Signup.billing_country'
        db.delete_column('courses_signup', 'billing_country')
    ...
    models = {
        ...
        'courses.signup': {
            ...
            'billing_country': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
