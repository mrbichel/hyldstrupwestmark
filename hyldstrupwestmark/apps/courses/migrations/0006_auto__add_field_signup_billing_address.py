...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signup.billing_address'
        db.add_column('courses_signup', 'billing_address',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Signup.billing_address'
        db.delete_column('courses_signup', 'billing_address')
